...
def test_adams_moulton_3_imagen():
    x0 = 0.0
    y0 = -1.0
    xf = 2.0
    ...
    method = AdamsMoulton3Method(f_expr, x0, y0, h, xf)
    results = method.solve()

    print("\nResultados para el ejercicio usando Adams-Moulton 3 (Predictor-Corrector):")
    print("--------------------------------------------------")
