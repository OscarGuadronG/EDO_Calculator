...
def test_adams_moulton_2_imagen():
    x0 = 0.0
    y0 = -1.0
    xf = 2.0
    ...
    method = AdamsMoulton2Method(f_expr, x0, y0, h, xf)
    results = method.solve()

    print("\nResultados para el ejercicio usando Adams-Moulton 2 (Predictor-Corrector):")
    print("--------------------------------------------------")
